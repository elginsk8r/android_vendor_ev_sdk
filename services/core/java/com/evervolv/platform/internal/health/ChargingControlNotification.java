...
public class ChargingControlNotification {
    ...
    private static final String CHARGING_CONTROL_CHANNEL_ID = "HealthChargingControl";
    ...
    ChargingControlNotification(Context context, ChargingControlController controller) {
        ...
        mContext.registerReceiver(new HealthNotificationBroadcastReceiver(),
                notificationFilter);
    }
    ...
    private class HealthNotificationBroadcastReceiver extends BroadcastReceiver {
        @Override
