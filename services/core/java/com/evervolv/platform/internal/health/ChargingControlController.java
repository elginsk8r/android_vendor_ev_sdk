...
public class ChargingControlController extends VendorHealthFeature {
    ...
    private HealthBatteryBroadcastReceiver mBattReceiver;
    ...
    private void onPowerConnected() {
        if (mBattReceiver == null) {
            mBattReceiver = new HealthBatteryBroadcastReceiver();
        }
    ...
    private class HealthBatteryBroadcastReceiver extends BroadcastReceiver {
        @Override
        public void onReceive(Context context, Intent intent) {
